...
Todo _todoDeserialize(
  ...
  object.prioritas = reader.readStringOrNull(offsets[1]);
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> prioritasIsNotNull() {
    return QueryBuilder.apply(this, (query) {
